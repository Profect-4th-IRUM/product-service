...
public class ProductInternalServiceTest {
    ...
    void updateStock_Success() {
        ...
        UpdateStockRequest.OptionValueRequest reqOption1 =
                new UpdateStockRequest.OptionValueRequest(optionValueId1, 5); // 5개 요청
        UpdateStockRequest.OptionValueRequest reqOption2 =
                new UpdateStockRequest.OptionValueRequest(optionValueId2, 10); // 10개 요청
        ...
        ProductOptionGroup mockOptionGroup =
                ProductOptionGroup.createOptionGroup(mockProduct, "옵션");
        ProductOptionValue pov1 =
                ProductOptionValue.createOptionValue(mockOptionGroup, "빨강", 100, 0); // 재고 100개
        ProductOptionValue pov2 =
                ProductOptionValue.createOptionValue(mockOptionGroup, "파랑", 50, 0); // 재고 50개
