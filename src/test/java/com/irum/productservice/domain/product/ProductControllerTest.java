...
//                                        fieldWithPath("detailDescription").description("상품 상세
// 설명"),
...
//                                        fieldWithPath("optionGroups[].name").description("옵션
// 그룹명"),
...
//                        "상의");
//
//        Mockito.when(productService.updateProduct(any(UUID.class),
...
//                                                .description("상품 공개 여부 (true = 공개, false =
// 비공개)")),
//                                responseFields(
//                                        fieldWithPath("success").description("API 성공 여부"),
//                                        fieldWithPath("status").description("HTTP 상태 코드"),
...
//                                        fieldWithPath("data.avgRating").description("평균 평점"),
//                                        fieldWithPath("data.reviewCount").description("리뷰 수"),
//                                        fieldWithPath("data.categoryId").description("변경된 카테고리
// ID"),
//
// fieldWithPath("data.categoryName").description("카테고리명"))));
//    }
...
//                                preprocessResponse(prettyPrint()),
//                                pathParameters(
//                                        parameterWithName("productId").description("상세 조회할 상품
// ID")),
//                                responseFields(
//                                        fieldWithPath("success").description("API 성공 여부"),
//                                        fieldWithPath("status").description("HTTP 상태 코드"),
...
//                                preprocessRequest(prettyPrint()),
//                                pathParameters(
//                                        parameterWithName("productId").description("삭제할 상품의
// ID"))));
//    }
//
//    // 8 상품 옵션 그룹 생성
...
//                                requestFields(
//                                        fieldWithPath("name").description("옵션 그룹명 (예: 색상, 사이즈
// 등)"),
