...
public class ProductInternalResponseMapper {
    ...
    public static ProductInternalResponse.ProductResponse toProductResponse(
            ProductOptionValue pov, Map<UUID, Integer> discountMap) {
        return new ProductInternalResponse.ProductResponse(
                ...
                pov.getExtraPrice(),
                discountMap.getOrDefault(pov.getOptionGroup().getProduct().getId(), 0),
                pov.getName(),
